...
def d():
    ...
    passive_id_1 = square.apply_passive_animation(lambda self, t: self.rotate(t*180, OUT))
    ...
    passive_id_2 = square2.apply_passive_animation(lambda self, t: self.move_to(square.location +
    ...
    square2.stop_passive_animation(passive_id_2)
    square.wait(2)
