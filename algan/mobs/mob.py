...
class Mob(Animatable):
    ...
    *args, **kwargs
            ...
            for c in self.children:
                ...
                if c.parent_batch_sizes is not None:
                    ...
                    interpolated_value = torch.repeat_interleave(
                        expand(interpolated_value, c), c.parent_batch_sizes, -2
                    )
            ...
            for c in self.children:
                ...
                if c.parent_batch_sizes is not None:
                    ...
                    change2 = torch.repeat_interleave(
                        expand(change2, c), c.parent_batch_sizes, -2
                    )
                c.apply_relative_change(
                    key,
                    change2,
                ...
                if c.parent_batch_sizes is not None:
                    ...
                    if isinstance(interpolation2, torch.Tensor):
                        interpolation2 = torch.repeat_interleave(
                            expand(interpolation2, c), c.parent_batch_sizes, -2
                        )
    ...
    def detach_history(self):
        ...
        #TODO explain why we use this (changing tensor dimensions isn't interpolable).
        """
