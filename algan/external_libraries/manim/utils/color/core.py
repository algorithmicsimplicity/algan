...
class ManimColor:
    ...
    def lighter(self, blend: float = 0.2) -> Self:
        ...
        :meth:`darker`
        """
        from ...utils.color.manim_colors import WHITE
    ...
    def contrasting(
        ...
        """
        from ...utils.color.manim_colors import BLACK, WHITE
...
ParsableManimColor: TypeAlias = Union[ManimColor, int, str, IntRGBLike, FloatRGBLike, IntRGBALike, FloatRGBALike]
...
def color_gradient(
    ...
    return [
        ...
        for i, alpha in _zip(floors, alphas_mod1, strict=True)
    ]
...
class RandomColorGenerator:
    ...
    def __init__(
        ...
        from ...utils.color.manim_colors import _all_manim_colors
