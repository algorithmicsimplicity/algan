...
class ManimColor:
    ...
    def darker(self, blend: float = 0.2) -> Self:
        ...
        :meth:`lighter`
        """
        from algan.external_libraries.manim.utils.color.manim_colors import BLACK
    ...
    def lighter(self, blend: float = 0.2) -> Self:
        ...
        :meth:`darker`
        """
        from algan.external_libraries.manim.utils.color.manim_colors import WHITE
    ...
    def contrasting(
        ...
        """
        from algan.external_libraries.manim.utils.color.manim_colors import BLACK, WHITE
...
def random_color() -> ManimColor:
    ...
    """
    import algan.external_libraries.manim.utils.color.manim_colors as manim_colors
