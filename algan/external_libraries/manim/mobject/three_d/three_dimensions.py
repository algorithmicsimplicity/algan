...
from ...mobject.geometry.polygram import Square
...
if TYPE_CHECKING:
    from ...mobject.graphing.coordinate_systems import ThreeDAxes
    from ...typing import Point3D, Point3DLike, Vector3D, Vector3DLike
