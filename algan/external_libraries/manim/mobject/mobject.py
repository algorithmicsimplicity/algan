...
class Mobject:
    ...
    def add_background_rectangle(
        ...
        **kwargs: Any,
        ...
        from ..mobject.geometry.shape_matchers import BackgroundRectangle
    ...
    def set_submobject_colors_by_gradient(self, *colors: ParsableManimColor) -> Self:
        ...
        for mob, color in _zip(mobs, new_colors, strict=True):
    ...
    def get_pieces(self, n_pieces: float) -> Group:
        ...
        return Group(
            *(
                ...
                for a1, a2 in _zip(alphas[:-1], alphas[1:], strict=True)
            )
        )
        ...
        .. manim:: Example
            ...
            class Example(Scene):
                def construct(self):
                    ...
                    self.add(x)
        """
        for m1, m2 in _zip(self.submobjects[:-1], self.submobjects[1:], strict=True):
        ...
        **kwargs: Any,
        ...
        def init_sizes(
            ...
            return [
                ...
                for size, measure in _zip(sizes, measures, strict=False)
            ]
    ...
    def align_data(self, mobject: Mobject, skip_point_alignment: bool = False) -> Self:
        ...
        # Recurse
        for m1, m2 in _zip(self.submobjects, mobject.submobjects, strict=True):
            m1.align_data(m2)
        return self
    ...
    def add_n_more_submobjects(self, n: int) -> Self | None:
        ...
        new_submobs = []
        for submob, sf in _zip(self.submobjects, split_factors, strict=True):
    ...
    def become(
        ...
        for sm1, sm2 in _zip(self.get_family(), mobject.get_family(), strict=True):
        ...
        .. manim:: MatchPointsScene
            ...
            class MatchPointsScene(Scene):
                def construct(self):
                    ...
                    self.wait(0.5)
        """
        for sm1, sm2 in _zip(self.get_family(), mobject.get_family(), strict=False):
            sm1.points = np.array(sm2.points)
        return self
