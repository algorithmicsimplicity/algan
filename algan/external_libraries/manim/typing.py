...
QuadraticBezierPointsLike: TypeAlias = Union[QuadraticBezierPoints, tuple[Point3DLike, Point3DLike, Point3DLike]]
"""``shape: (3, 3)``
...
CubicBezierPointsLike: TypeAlias = Union[CubicBezierPoints, tuple[Point3DLike, Point3DLike, Point3DLike, Point3DLike]]
"""``shape: (4, 3)``
...
CubicBezierPointsLike_Array: TypeAlias = Union[CubicBezierPoints_Array, Sequence[CubicBezierPointsLike]]
"""``shape: (N, 4, 3)``
...
BezierPointsLike_Array: TypeAlias = Union[BezierPoints_Array, Sequence[BezierPointsLike]]
r"""``shape: (N, PPC, 3)``
