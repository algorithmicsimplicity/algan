...
from algan.external_libraries.ground.core.primitive import to_rational_point
...
def intersect(
    ...
    if containment_checker(first_start, first_end, second_start):
        ...
        first_start, first_end = (
            to_rational_point(first_start, point_cls),
            to_rational_point(first_end, point_cls),
        )
        second_start, second_end = (
            to_rational_point(second_start, point_cls),
