...
from algan.external_libraries.ground.core.enums import Orientation, Relation
from algan.external_libraries.ground.core.hints import Point, TernaryPointFunction
from . import exact

CollisionDetector = Callable[[Point, Point, Point, Point, TernaryPointFunction], bool]
ContainmentChecker = Callable[
    [Point, Point, Point, TernaryPointFunction[Orientation]], bool
]
Intersector = Callable[
    [Point, Point, Point, Point, Type[Point], TernaryPointFunction[bool]], Point
]
Relater = Callable[
    [Point, Point, Point, Point, TernaryPointFunction[Orientation]], Relation
]
...
class Context:
    ...
    def collision_detector(
        ...
        if (
            ...
            and _bounding_box_contains_point(first_start, first_end, second_end)
        ):
            return True
        ...
        if (
            ...
            and _bounding_box_contains_point(second_start, second_end, first_end)
        ):
            return True
    ...
    def relater(
        ...
        if (
            ...
            if test_start_orientation is test_end_orientation:
                ...
                goal_start_orientation = orienteer(test_start, test_end, goal_start)
            ...
            return Relation.COMPONENT if test_end < goal_end else Relation.COMPOSITE
        elif ends_equal:
...
def _bounding_box_contains_point(start: Point, end: Point, point: Point) -> bool:
