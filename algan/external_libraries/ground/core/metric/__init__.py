...
from .exact import box as exact_box, point as exact_point, segment as exact_segment

BoxPointMetric = Callable[[Box, Point], None]
BoxSegmentMetric = Callable[
    [
        Box,
        Segment,
...
SegmentPointMetric = Callable[
    [Point, Point, Point, QuaternaryPointFunction[None]], None
]
SegmentSegmentMetric = Callable[
    [
        Point,
        Point,
        Point,
