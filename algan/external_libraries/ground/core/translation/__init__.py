...
PointTranslator = Callable[[Point, Type[Point]], Point]
...
class Context:
        ...
        return multipolygon_cls(
            [
                self.translate_polygon(
                    polygon, step_x, step_y, contour_cls, point_cls, polygon_cls
                )
    ...
    def translate_multisegment(
        ...
        return multisegment_cls(
            [
                self.translate_segment(segment, step_x, step_y, point_cls, segment_cls)
    ...
    def translate_polygon(
        ...
        return polygon_cls(
            ...
            [
                self.translate_contour(hole, step_x, step_y, contour_cls, point_cls)
