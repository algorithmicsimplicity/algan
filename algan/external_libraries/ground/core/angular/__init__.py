...
from .exact import kind as exact_kind, orientation as exact_orientation
...
class Context:
    ...
    def __init__(
        ...
        orientation: TernaryPointFunction[Orientation],
    ) -> None:
...
exact_context = Context(kind=exact_kind, orientation=exact_orientation)
