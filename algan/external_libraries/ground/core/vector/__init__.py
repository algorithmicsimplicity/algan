...
from .exact import cross as exact_cross, dot as exact_dot
...
class Context:
    ...
    def __init__(
        self, cross_product: QuaternaryFunction, dot_product: QuaternaryFunction
    ) -> None:
...
exact_context = Context(
    cross_product=exact_cross.multiply, dot_product=exact_dot.multiply
)
