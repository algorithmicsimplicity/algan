...
MultisegmentCentroid = Callable[[Multisegment, Type[Point], None], Point]
...
class Context:
    ...
    def __init__(
        ...
        segment_centroid: SegmentCentroid,
    ) -> None:
...
exact_context = Context(
    contour_centroid=exact_contour.centroid,
