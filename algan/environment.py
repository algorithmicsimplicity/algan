...
_IMPORT_TIME_VARIABLES = (
    ...
    "ALGAN_PT_AMBIENT_ROWS",
    "ALGAN_PT_ANIMATED_SEED",
    "ALGAN_PT_AREA_LIGHT_QUADS",
    "ALGAN_PT_AUTHORED_LIGHT_SAMPLING",
    "ALGAN_PT_BLUE_NOISE",
    "ALGAN_PT_ENV_NEE",
    "ALGAN_PT_ERROR_TARGET",
    "ALGAN_PT_FIREFLY_CLAMP",
    "ALGAN_PT_LIGHT_SAMPLES",
    "ALGAN_PT_LIGHT_TREE",
    "ALGAN_PT_MIN_SAMPLES",
    "ALGAN_PT_OPAQUE_CLOSEST",
    "ALGAN_PT_RR_START",
    "ALGAN_PT_SEED",
    "ALGAN_PT_SHADOW_ANYHIT",
    "ALGAN_PT_WAVE",
    ...
    "ALGAN_RASTER_SPAN_CANDIDATES",
    "ALGAN_RASTER_SPARSE_COVERAGE",
    "ALGAN_RASTER_SS",
    "ALGAN_RASTER_STRADDLE_CLIP",
    "ALGAN_RASTER_TRI_PRECOMPUTE",
    "ALGAN_RASTER_WRITE_COMPACT",
    "ALGAN_REFIT_PACK_KERNEL",
    "ALGAN_RGB_SHADOW_TINT",
    "ALGAN_SAH_BINS",
    "ALGAN_SHADOW_ADAPTIVE_TAPS",
    "ALGAN_SHADOW_ANYHIT",
    "ALGAN_SHADOW_BOUNCE_RAYS",
    "ALGAN_SHADOW_DEFERRED_SINGLE_SAMPLE",
    "ALGAN_SHADOW_EPS_RELATIVE",
    "ALGAN_SHADOW_IDENTITY_REJECT",
    "ALGAN_SHADOW_LIGHT_MAJOR",
    "ALGAN_SHADOW_NEAR_FRACTION",
    "ALGAN_SHADOW_PRIMARY_SORT",
    "ALGAN_SHADOW_RAY_BUDGET",
    "ALGAN_SHADOW_RAY_PARALLEL",
    "ALGAN_SHADOW_SECONDARY_SORT",
    "ALGAN_SHADOW_SIDED_CULL",
    "ALGAN_SHADOW_TERMINATOR",
    "ALGAN_SHEET_BAND_STATS_KERNEL",
    "ALGAN_SHEET_CLASS_RUN_SORT",
    "ALGAN_SHEET_DEPTH_BUFFER_REUSE",
    "ALGAN_SHEET_DEPTH_REDUCE_KERNEL",
    "ALGAN_SHEET_DEVICE_RUNS",
    "ALGAN_SHEET_FRAGMENT_RUN_SORT",
    "ALGAN_SHEET_FUSED_STREAM",
    "ALGAN_SHEET_GROUP_REUSE",
    "ALGAN_SHEET_MASK_KERNEL",
    "ALGAN_SHEET_METADATA_KERNEL",
    "ALGAN_SHEET_ONE_MESH_KERNEL",
    "ALGAN_SHEET_PACKED_SORT",
    "ALGAN_SHEET_PIXEL_SORT",
    "ALGAN_SHEET_POSITIONED_DEPTH",
    "ALGAN_SHEET_RANK_GROUPS",
    ...
    "ALGAN_SHEET_SIBLING_WEIGHTS_KERNEL",
    "ALGAN_SLIVER_SPLIT_ASPECT",
    "ALGAN_SLIVER_SPLIT_MAX_PIECES",
    "ALGAN_SLIVER_SPLIT_MIN_PIECE",
    ...
    "ALGAN_WF_RAY_SORT",
    "ALGAN_WF_RAY_SORT_COMPACT",
    "ALGAN_WF_RAY_SORT_MIN",
    "ALGAN_WF_REVALIDATE_PENDING",
    "ALGAN_WF_SHADOW_EVENT_SORT",
...
_LIVE_VARIABLES = (
    ...
    "ALGAN_DEVICE_RADIX_SORT",
    "ALGAN_DEVICE_RADIX_SORT_MIN",
    "ALGAN_FLUSH_KERNEL_CACHE",
    "ALGAN_LOG_LEVEL",
    "ALGAN_LOG_TAICHI_COMPILES",
    "ALGAN_MANIM_SVG_CACHE_MB",
    "ALGAN_MPS_FRIENDLY",
    "ALGAN_MPS_HOST_SHARE",
    "ALGAN_MPS_MEMORY_CAP",
    "ALGAN_MPS_SHARED_QUEUE",
    ...
    "ALGAN_PROGRESS",
    "ALGAN_RASTER_KEY_CHECK",
    "ALGAN_REUSE_FETCHED_BATCH",
    "ALGAN_SHADOW_VIS_EXACT",
