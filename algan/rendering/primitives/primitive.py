...
class RenderPrimitive:
    ...
    def post_process_frames(self, frames, anti_alias_level, post_processes=[]):
        ...
        from algan.rendering.raytracing.primitives import is_post_process_tonemap_enabled, TONEMAP_EXPOSURE, TONEMAP_METHOD, TONEMAPPING
        if is_post_process_tonemap_enabled():
            ...
            if TONEMAPPING:
                ...
                if TONEMAP_METHOD == "neutral":
                    ...
                    r_rec2020 = 0.627409 * color_exposed_flat[:, 0] + 0.329282 * color_exposed_flat[:, 1] + 0.043309 * color_exposed_flat[:, 2]
                    g_rec2020 = 0.069055 * color_exposed_flat[:, 0] + 0.919540 * color_exposed_flat[:, 1] + 0.011405 * color_exposed_flat[:, 2]
                    b_rec2020 = 0.016390 * color_exposed_flat[:, 0] + 0.088013 * color_exposed_flat[:, 1] + 0.895597 * color_exposed_flat[:, 2]
