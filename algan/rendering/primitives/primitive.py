...
class RenderPrimitive:
    ...
    def blend_frags_to_pixels(
        ...
        def blend_colors(dists, inds, colors, out):
            ...
            for _ in range(max_buffer_depth):
    ...
    def render_(
        ...
        corners_locs, _, projected_distances = corners, corners_int, projected_distances
