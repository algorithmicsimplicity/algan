...
html_theme_options = {
    ...
    # Wordmarks are generated by branding/make_logo_svg.py (outlined Open Sans
    # Semibold glyphs, so they need no web font). Keep their viewBox aspect ratio.
...
ogp_social_cards = {
    "image": "_static/algan-banner.png",
}
