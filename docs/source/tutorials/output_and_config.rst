...
.. algan:: SquareToCircle3
    ...
    circle.set_color(PINK).set_opacity(0.1)   # set color and transparency

    square = Square()                    # create a square
    square.rotate(180, RIGHT)#                  # flip horizontally
    square.rotate(-3 * TAU / 8, UP)          # rotate a certain amount

    square.spawn()      # animate the creation of the square
    square.become(circle)  # interpolate the square into the circle
